    ...
    return (
        <div className="w-full py-2 ">
            <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-light text-gray-600">{dateFormat(comment.createdAt)}</span>
            </div>
                {editOpen ? 
            ...
            {session?.user?.id == comment.user.id ? 
                <div className="flex items-center gap-2 pt-1 pb-2 justify-end border-b">
                     <Button size="small" button={true} mode="save" onClick={() => setEditOpen(true)}>
                        edit
                    </Button>
                    <Button size="small" button={true} mode="danger" onClick={deleteComment}>
                        delete
                    </Button>
                </div>
            : null}
